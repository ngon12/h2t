(function($) {
    ...
    header.behaviour;
    header.qodefHeaderBehaviour = qodefHeaderBehaviour;
    ...
    function qodefHeaderBehaviour() {
        ...
        switch(true) {
            ...
            case qodef.body.hasClass('qodef-sticky-header-on-scroll-down-up'):
                ...
                }else if($('.qodef-slider .carousel').length){
                    qodef.modules.header.stickyAppearAmount = $('.qodef-slider .carousel').height();
                }else{
    ...
    */
    ...
    function qodefSearch() {
        ...
        function qodefSearchCoversHeader() {
            ...
            searchOpener.click( function(e) {
                ...
                if ( searchFormLandmark.parent().hasClass('qodef-logo-area') ) {
                    ...
                    searchFormHeight = qodefGlobalVars.vars.qodefMenuAreaHeight - qodefGlobalVars.vars.qodefTopBarHeight;
                ...
                } else if ( searchFormLandmark.parent().hasClass('qodef-mobile-header-holder') ) {
        ...
        /**
         * Fullscreen search (two types: fade)
         */
