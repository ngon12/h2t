...
/*
  Class: KloeQodefIconCollections
...
class KloeQodefIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new KloeQodefIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new KloeQodefIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new KloeQodefIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new KloeQodefLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new KloeQodefSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new KloeQodefDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getIconCollectionIcons(iKloeQodefIconCollection $collection) {
...
$kloe_qodef_IconCollections = KloeQodefIconCollections::get_instance();