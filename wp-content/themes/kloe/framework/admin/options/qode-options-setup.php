...
add_action('after_setup_theme', 'kloe_qodef_admin_map_init', 0);

function kloe_qodef_admin_map_init() {

    do_action('kloe_qodef_before_options_map');
    ...
    do_action('kloe_qodef_options_map');

    do_action('kloe_qodef_after_options_map');
