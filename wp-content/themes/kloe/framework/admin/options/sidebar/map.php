...
if ( ! function_exists('kloe_qodef_sidebar_options_map') ) {

	function kloe_qodef_sidebar_options_map() {
		...
		$panel_widgets = kloe_qodef_add_admin_panel(
			array(
				'page'  => '_sidebar_page',
				'name'  => 'panel_widgets',
				'title' => 'Widgets'
		...
		$group_sidebar_padding = kloe_qodef_add_admin_group(array(
			'name'		=> 'group_sidebar_padding',
			'title'		=> 'Padding',
			'parent'	=> $panel_widgets
		));

		$row_sidebar_padding = kloe_qodef_add_admin_row(array(
	...
	add_action( 'kloe_qodef_options_map', 'kloe_qodef_sidebar_options_map', 10);
