...
if ( ! function_exists('kloe_qodef_social_options_map') ) {

	function kloe_qodef_social_options_map() {
		 ...
		 * Enable Social Share
		 */
		$panel_social_share = kloe_qodef_add_admin_panel(array(
			'page'  => '_social_page',
		...
		$panel_show_social_share_on = kloe_qodef_add_admin_panel(array(
			'page'  			=> '_social_page',
		 ...
		 */
		$panel_social_networks = kloe_qodef_add_admin_panel(array(
			'page'  			=> '_social_page',
		...
		$enable_facebook_share_container = kloe_qodef_add_admin_container(array(
		...
		$enable_twitter_share_container = kloe_qodef_add_admin_container(array(
		...
		$enable_google_plus_container = kloe_qodef_add_admin_container(array(
		...
		$enable_linkedin_container = kloe_qodef_add_admin_container(array(
		...
		$enable_tumblr_container = kloe_qodef_add_admin_container(array(
		...
		$enable_pinterest_container = kloe_qodef_add_admin_container(array(
		...
		$enable_vk_container = kloe_qodef_add_admin_container(array(
		...
		if(defined('QODEF_TWITTER_FEED_VERSION')) {
            $twitter_panel = kloe_qodef_add_admin_panel(array(
                'title' => 'Twitter',
                'name'  => 'panel_twitter',
                'page'  => '_social_page'
            ));

            kloe_qodef_add_admin_twitter_button(array(
                'name'   => 'twitter_button',
        ...
        if(defined('QODEF_INSTAGRAM_FEED_VERSION')) {
            $instagram_panel = kloe_qodef_add_admin_panel(array(
                'title' => 'Instagram',
                'name'  => 'panel_instagram',
                'page'  => '_social_page'
            ));

            kloe_qodef_add_admin_instagram_button(array(
	...
	add_action( 'kloe_qodef_options_map', 'kloe_qodef_social_options_map', 16);
}