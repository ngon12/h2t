...
if ( ! function_exists('kloe_qodef_general_options_map') ) {
    /**
     * General options page
     */
    function kloe_qodef_general_options_map() {
        ...
        $panel_design_style = kloe_qodef_add_admin_panel(
            array(
                'page'  => '',
        ...
        $additional_google_fonts_container = kloe_qodef_add_admin_container(
            array(
                'parent'            => $panel_design_style,
        ...
        $boxed_container = kloe_qodef_add_admin_container(
            array(
                'parent'            => $panel_design_style,
        ...
        $panel_settings = kloe_qodef_add_admin_panel(
            array(
                'page'  => '',
                'name'  => 'panel_settings',
                'title' => 'Settings'
        ...
        $page_transitions_container = kloe_qodef_add_admin_container(
            array(
                'parent'            => $panel_settings,
        ...
        $group_pt_spinner_animation = kloe_qodef_add_admin_group(array(
        ...
        $row_pt_spinner_animation = kloe_qodef_add_admin_row(array(
        ...
        $panel_custom_code = kloe_qodef_add_admin_panel(
            array(
                'page'  => '',
    ...
    add_action( 'kloe_qodef_options_map', 'kloe_qodef_general_options_map', 1);
