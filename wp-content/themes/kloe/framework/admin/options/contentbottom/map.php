...
if ( ! function_exists('kloe_qodef_content_bottom_options_map') ) {

	function kloe_qodef_content_bottom_options_map() {
		...
		$panel_content_bottom = kloe_qodef_add_admin_panel(
			array(
		...
		$enable_content_bottom_area_container = kloe_qodef_add_admin_container(
			array(
				'parent'            => $panel_content_bottom,
	...
	add_action( 'kloe_qodef_options_map', 'kloe_qodef_content_bottom_options_map', 19);
