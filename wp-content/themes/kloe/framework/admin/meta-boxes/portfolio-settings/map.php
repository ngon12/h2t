...
if(!function_exists('kloe_qodef_map_portfolio_settings')) {
    function kloe_qodef_map_portfolio_settings() {
    ...
    add_action('kloe_qodef_meta_boxes_map', 'kloe_qodef_map_portfolio_settings');
}