<?php
namespace KloeQodef\Modules\Counter;
...
class Countdown implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			...
			'base' => $this->getBase(),
			'category' => 'by SELECT',
			'admin_enqueue_css' => array(kloe_qodef_get_skin_uri().'/assets/css/qodef-vc-extend.css'),
	...
	public function render($atts, $content = null)
	{
		...
		$html = kloe_qodef_get_shortcode_module_template_part('templates/countdown-template', 'countdown', '', $params);
