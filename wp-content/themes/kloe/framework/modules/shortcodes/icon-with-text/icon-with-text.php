<?php
namespace KloeQodef\Modules\Shortcodes\IconWithText;

use KloeQodef\Modules\Shortcodes\Lib\ShortcodeInterface;

/**
 * Class IconWithText
 * @package KloeQodef\Modules\Shortcodes\IconWithText
 */
class IconWithText implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            ...
            'params'                    => array_merge(
                kloe_qodef_icon_collections()->getVCParamsArray(),
                array(
                    array(
                        'type'       => 'attach_image',
                        'heading'    => 'Custom Icon',
    ...
    public function render($atts, $content = null) {
        ...
        return kloe_qodef_get_shortcode_module_template_part('templates/iwt', 'icon-with-text', $params['icon_position'], $params);
    }
    ...
    private function getIconParameters($params) {
        ...
        if(empty($params['custom_icon'])) {
            ...
            if(!empty($params['hover_effect'])) {
                $params_array['hover_effect'] = $params['hover_effect'];
            }

            if(!empty($params['hover_effect_background_color'])) {
                $params_array['hover_effect_background_color'] = $params['hover_effect_background_color'];
            }
    ...
    private function getContentStyles($params) {
        ...
        if($params['icon_position'] == 'left' && !empty($params['text_left_padding'])) {
            $styles[] = 'padding-left: '.kloe_qodef_filter_px($params['text_left_padding']).'px';
        }

        if($params['icon_position'] == 'right' && !empty($params['text_right_padding'])) {
            $styles[] = 'padding-right: '.kloe_qodef_filter_px($params['text_right_padding']).'px';
        }
