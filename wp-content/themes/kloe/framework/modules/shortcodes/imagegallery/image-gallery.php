<?php
namespace KloeQodef\Modules\Shortcodes\ImageGallery;
...
class ImageGallery implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$params['image_gallery_classes'] = $this->getImageGalleryClass($params);
		...
		$html = kloe_qodef_get_shortcode_module_template_part('templates/' . $template, 'imagegallery', '', $params);
	...
	private function getImageGalleryClass($params) {

		$galleryClass = '';

		if($params['type'] == 'slider') {
			if($params['pagination'] == 'yes') {
				$galleryClass .= 'qodef-pagination-enabled';
			}
		}
