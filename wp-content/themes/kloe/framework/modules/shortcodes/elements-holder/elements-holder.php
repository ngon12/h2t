<?php
namespace KloeQodef\Modules\ElementsHolder;
...
class ElementsHolder implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html .= '<div ' . kloe_qodef_get_class_attribute($elements_holder_class) . ' ' . kloe_qodef_get_inline_attr($elements_holder_style, 'style'). '>';
