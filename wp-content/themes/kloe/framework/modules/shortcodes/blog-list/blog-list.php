...
namespace KloeQodef\Modules\BlogList;
...
class BlogList implements ShortcodeInterface {
	...
	*/
	...
	public function render($atts, $content = null) {
		...
		$html ='';
        $html .= kloe_qodef_get_shortcode_module_template_part('templates/blog-list-holder', 'blog-list', '', $params);
		return $html;
	...
	*/
	private function generateImageSize($params){
		...
		if ($imageSize !== '' && $imageSize == 'landscape') {
            $thumbImageSize .= 'kloe_qodef_landscape';
        } else if($imageSize === 'square'){
			$thumbImageSize .= 'kloe_qodef_square';
		} else if ($imageSize !== '' && $imageSize == 'original') {
            $thumbImageSize .= 'full';
        }

		if($params['type'] == 'image_in_box') {
			$thumbImageSize = array(70, 55);
		}
