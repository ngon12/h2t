<?php
namespace KloeQodef\Modules\Separator;
...
class Separator implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html = kloe_qodef_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['width'] !== '') {
			if(kloe_qodef_string_ends_with($params['width'], '%') || kloe_qodef_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(kloe_qodef_string_ends_with($params['top_margin'], '%') || kloe_qodef_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(kloe_qodef_string_ends_with($params['bottom_margin'], '%') || kloe_qodef_string_ends_with($params['bottom_margin'], 'px')) {
