<div class="qodef-progress-bar">
	...
	<div class="qodef-progress-content-outer " <?php  echo kloe_qodef_get_inline_style($inactive_bar_style)?>>
		<div data-percentage=<?php echo esc_attr($percent)?> class="qodef-progress-content" <?php  echo kloe_qodef_get_inline_style($active_bar_style)?>></div>
	</div>
</div>	