<?php
namespace KloeQodef\Modules\Shortcodes\ShopMasonry;
...
class ShopMasonry implements ShortcodeInterface
{
    ...
    public function render($atts, $content = null)
    {
        ...
        if($filter == 'yes'){
            ...
            $html .= kloe_qodef_get_shortcode_module_template_part('templates/shop-filter','shop-masonry', '', $params);
        }
        ...
        if ( $products->have_posts() ) :
            ...
            while ( $products->have_posts() ) : $products->the_post();
                ...
                $html .= kloe_qodef_get_shortcode_module_template_part('templates/shop-masonry-template','shop-masonry','',$params);
