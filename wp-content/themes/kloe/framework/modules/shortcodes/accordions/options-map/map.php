<?php 
if(!function_exists('kloe_qodef_accordions_map')) {
    /**
     * Add Accordion options to elements panel
     */
   function kloe_qodef_accordions_map() {
       ...
       kloe_qodef_add_admin_field(array(
		...
		$accordions_color_group = kloe_qodef_add_admin_group(array(
           'name' => 'accordions_color_group',
           'title' => 'Accordion Color Styles',
			'description' => 'Set color styles for accordion title',
           'parent' => $panel
       ));
		$accordions_color_row = kloe_qodef_add_admin_row(array(
		...
		$active_accordions_color_group = kloe_qodef_add_admin_group(array(
		...
		$active_accordions_color_row = kloe_qodef_add_admin_row(array(
		...
		$boxed_accordions_color_group = kloe_qodef_add_admin_group(array(
           'name' => 'boxed_accordions_color_group',
           'title' => 'Boxed Accordion Title Color Styles',
			'description' => 'Set color styles for boxed accordion title',
           'parent' => $panel
       ));
		$boxed_accordions_color_row = kloe_qodef_add_admin_row(array(
      ...
      $active_boxed_accordions_color_group = kloe_qodef_add_admin_group(array(
           'name' => 'active_boxed_accordions_color_group',
           'title' => 'Active and Hover Title Color Styles',
			'description' => 'Set color styles for active and hover accordions',
           'parent' => $panel
       ));
		$active_boxed_accordions_color_row = kloe_qodef_add_admin_row(array(
   ...
   add_action('kloe_qodef_options_elements_map', 'kloe_qodef_accordions_map');
}