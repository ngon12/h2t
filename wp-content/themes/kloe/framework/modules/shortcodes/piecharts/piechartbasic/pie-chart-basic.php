<?php
namespace KloeQodef\Modules\PieCharts\PieChartBasic;
...
class PieChartBasic implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = kloe_qodef_get_shortcode_module_template_part('templates/pie-chart-basic', 'piecharts/piechartbasic', '', $params);
