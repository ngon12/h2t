...
if(!function_exists('kloe_qodef_button_map')) {
    function kloe_qodef_button_map() {
        ...
        $outline_group = kloe_qodef_add_admin_group(array(
            'name' => 'outline_group',
            'title' => 'Outline Type',
        ...
        $outline_row = kloe_qodef_add_admin_row(array(
            'name' => 'outline_row',
            'next' => true,
        ...
        $outline_row2 = kloe_qodef_add_admin_row(array(
            'name' => 'outline_row2',
            'next' => true,
            'parent' => $outline_group
        ));
        ...
        //Solid type options
        $solid_group = kloe_qodef_add_admin_group(array(
            'name' => 'solid_group',
            'title' => 'Solid Type',
        ...
        $solid_row = kloe_qodef_add_admin_row(array(
            'name' => 'solid_row',
            'next' => true,
            'parent' => $solid_group
        ));
        ...
        $solid_row2 = kloe_qodef_add_admin_row(array(
            'name' => 'solid_row2',
            'next' => true,
            'parent' => $solid_group
        ));
    ...
    add_action('kloe_qodef_options_elements_map', 'kloe_qodef_button_map');
}