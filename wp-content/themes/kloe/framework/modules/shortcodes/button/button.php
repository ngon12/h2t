<?php
namespace KloeQodef\Modules\Shortcodes\Button;
 ...
 * @package KloeQodef\Modules\Shortcodes\Button
 */
class Button implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            ...
            'params'                    => array_merge(
                ...
                kloe_qodef_icon_collections()->getVCParamsArray(array(), '', true),
                array(
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Color',
                    ...
                    array(
                        ...
                        'heading'     => 'Margin',
                        'param_name'  => 'margin',
                        'description' => esc_html__('Insert margin in format: 0px 0px 1px 0px', 'kloe'),
                        'admin_label' => true,
                        'group'       => 'Design Options'
                    )
                )
    ...
    public function render($atts, $content = null) {
        ...
        return kloe_qodef_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', $params['hover_animation'], $params);
    }
    ...
    private function getButtonStyles($params) {
        ...
        if(!empty($params['font_size'])) {
            $styles[] = 'font-size: '.kloe_qodef_filter_px($params['font_size']).'px';
        }
