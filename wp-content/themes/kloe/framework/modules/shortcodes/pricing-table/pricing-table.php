<?php
namespace KloeQodef\Modules\PricingTable;
...
class PricingTable implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$params['pricing_table_style'] = $this->getTableStyle($params);
		$params['content']= $content;
		
		$html .= kloe_qodef_get_shortcode_module_template_part('templates/pricing-table-template','pricing-table', '', $params);
		return $html;
