<?php
namespace KloeQodef\Modules\Tabs;
...
class Tabs implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$output .= kloe_qodef_get_shortcode_module_template_part('templates/'.$tabs_type,'tabs', '', $params);
		...
		private function getTabClass($params){
			...
			$tabSkin = $params['title_skin'];
			switch($tabSkin) {
				case 'dark':
					$tabClass .= ' qodef-tab-dark';
				break;
				case 'light':
					$tabClass .= ' qodef-tab-light';
				break;
			}
			return $tabClass;
		}
