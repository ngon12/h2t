...
if ( ! function_exists('kloe_qodef_logo_options_map') ) {

	function kloe_qodef_logo_options_map() {
		...
		$panel_logo = kloe_qodef_add_admin_panel(
			array(
				'page' => '_logo_page',
				'name' => 'panel_logo',
				'title' => 'Logo'
		...
		$hide_logo_container = kloe_qodef_add_admin_container(
			array(
				'parent' => $panel_logo,
	...
	add_action( 'kloe_qodef_options_map', 'kloe_qodef_logo_options_map', 2);
