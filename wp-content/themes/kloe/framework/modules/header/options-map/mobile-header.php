...
if ( ! function_exists('kloe_qodef_mobile_header_options_map') ) {

	function kloe_qodef_mobile_header_options_map() {
		...
		$panel_mobile_header = kloe_qodef_add_admin_panel(array(
			'title' => 'Mobile header',
		...
		kloe_qodef_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => kloe_qodef_get_text_transform_array(true)
		));
		...
		kloe_qodef_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => kloe_qodef_get_font_style_array(true)
		));
		...
		kloe_qodef_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => kloe_qodef_get_font_weight_array(true)
		));
		...
		kloe_qodef_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => kloe_qodef_icon_collections()->getIconCollectionsExclude(array('linea_icons', 'simple_line_icons'))
		));
	...
	add_action( 'kloe_qodef_options_map', 'kloe_qodef_mobile_header_options_map', 4);
