...
if ( ! function_exists('kloe_qodef_woocommerce_options_map') ) {

	/**
	 * Add Woocommerce options page
	 */
	function kloe_qodef_woocommerce_options_map() {
		 ...
		 */
		$panel_product_list = kloe_qodef_add_admin_panel(
			array(
		 ...
		 */
		$panel_single_product = kloe_qodef_add_admin_panel(
			array(
				'page' => '_woocommerce_page',
	...
	add_action( 'kloe_qodef_options_map', 'kloe_qodef_woocommerce_options_map', 21);
