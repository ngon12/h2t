...
if ( ! function_exists('kloe_qodef_footer_options_map') ) {
	/**
	 * Add footer options
	 */
	function kloe_qodef_footer_options_map() {
		...
		$footer_panel = kloe_qodef_add_admin_panel(
			array(
				'title' => 'Footer',
				'name' => 'footer',
				'page' => '_footer_page'
		...
		$show_footer_top_container = kloe_qodef_add_admin_container(
			array(
		...
		$show_footer_bottom_container = kloe_qodef_add_admin_container(
			array(
	...
	add_action( 'kloe_qodef_options_map', 'kloe_qodef_footer_options_map', 5);
