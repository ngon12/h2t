...
if ( ! function_exists('kloe_qodef_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function kloe_qodef_configure_visual_composer() {
	...
	add_action('vc_after_init', 'kloe_qodef_configure_visual_composer');

}


if ( ! function_exists('kloe_qodef_configure_visual_composer_grid_elemets') ) {
	...
	function kloe_qodef_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'kloe_qodef_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('kloe_qodef_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function kloe_qodef_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'kloe_qodef_configure_visual_composer_frontend_editor');
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_Qodef_Fixed_Background_Holder extends WPBakeryShortCodesContainer {}
...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	...
	class WPBakeryShortCode_Qodef_Service_Table extends WPBakeryShortCode {}
	class WPBakeryShortCode_Qodef_Fixed_Background_Item extends WPBakeryShortCode {}
}

/*** Row ***/
if ( ! function_exists('kloe_qodef_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function kloe_qodef_vc_row_map()
	{
	...
	add_action('vc_after_init', 'kloe_qodef_vc_row_map');
}
