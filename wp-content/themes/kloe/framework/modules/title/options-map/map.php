...
if ( ! function_exists('kloe_qodef_title_options_map') ) {

	function kloe_qodef_title_options_map() {
		...
		$panel_title = kloe_qodef_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
		...
		$show_title_area_container = kloe_qodef_add_admin_container(
			array(
				'parent' => $panel_title,
		...
		$title_area_type_container = kloe_qodef_add_admin_container(
			array(
				'parent' => $show_title_area_container,
		...
		$title_area_background_image_responsive_container = kloe_qodef_add_admin_container(
			array(
				'parent' => $show_title_area_container,
		...
		$panel_typography = kloe_qodef_add_admin_panel(
			array(
				'page' => '_title_page',
		...
		$group_page_title_styles = kloe_qodef_add_admin_group(array(
		...
		$row_page_title_styles_1 = kloe_qodef_add_admin_row(array(
		...
		$row_page_title_styles_2 = kloe_qodef_add_admin_row(array(
		...
		$group_page_subtitle_styles = kloe_qodef_add_admin_group(array(
		...
		$row_page_subtitle_styles_1 = kloe_qodef_add_admin_row(array(
		...
		$row_page_subtitle_styles_2 = kloe_qodef_add_admin_row(array(
		...
		$group_page_breadcrumbs_styles = kloe_qodef_add_admin_group(array(
		...
		$row_page_breadcrumbs_styles_1 = kloe_qodef_add_admin_row(array(
		...
		$row_page_breadcrumbs_styles_2 = kloe_qodef_add_admin_row(array(
		...
		$row_page_breadcrumbs_styles_3 = kloe_qodef_add_admin_row(array(
	...
	add_action( 'kloe_qodef_options_map', 'kloe_qodef_title_options_map',6);
