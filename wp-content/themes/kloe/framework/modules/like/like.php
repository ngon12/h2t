...
class KloeQodefLike {
	...
	private function __construct() {
		...
		add_action('wp_ajax_kloe_qodef_like', array( $this, 'ajax'));
		add_action('wp_ajax_nopriv_kloe_qodef_like', array( $this, 'ajax'));
	}
	...
	public function add_like() {
		...
		$title = esc_html__('Like this', 'kloe');
		if( isset($_COOKIE['qodef-like_'. $post->ID]) ){
			$class = 'qodef-like liked';
			$title = esc_html__('You already like this!', 'kloe');
		}
...
global $kloe_qodef_like;
$kloe_qodef_like = KloeQodefLike::get_instance();
