...
if ( ! function_exists('kloe_qodef_portfolio_options_map') ) {

	function kloe_qodef_portfolio_options_map() {
		...
		kloe_qodef_add_admin_field(array(
				...
				'description'   => 'Enabling this option will disable related projects on Single Projects.',
				'parent'        => $panel,
				'default_value' => 'no'
		));
		...
		$container_navigate_category = kloe_qodef_add_admin_container(array(
	...
	add_action( 'kloe_qodef_options_map', 'kloe_qodef_portfolio_options_map', 12);
