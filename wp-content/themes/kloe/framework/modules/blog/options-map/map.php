...
if ( ! function_exists('kloe_qodef_blog_options_map') ) {

	function kloe_qodef_blog_options_map() {
		...
		$panel_blog_lists = kloe_qodef_add_admin_panel(
			array(
				'page' => '_blog_page',
		...
		if(count($custom_sidebars) > 0) {
			kloe_qodef_add_admin_field(array(
				...
				'parent' => $panel_blog_lists,
				'options' => kloe_qodef_get_custom_sidebars()
			));
		}
		...
		$pagination_container = kloe_qodef_add_admin_container(
			array(
		...
		kloe_qodef_add_admin_field(array(
			...
			'description' => 'Choose a type of pagination for Standard and Centered blog lists',
			'default_value' => 'standard',
			'parent'      => $pagination_container,
			'options'     => array(
		...
		kloe_qodef_add_admin_field(
			array(
				'type' => 'text',
				'name' => 'centered_number_of_chars',
				'default_value' => '',
				'label' => 'Centered Type Number of Words in Excerpt',
				'parent' => $panel_blog_lists,
				'description' => 'Enter a number of words in excerpt (article summary)',
				'args' => array(
					'col_width' => 3
		 ...
		 * Blog Single
		 */
		$panel_blog_single = kloe_qodef_add_admin_panel(
			array(
				'page' => '_blog_page',
		...
		$blog_single_navigation_container = kloe_qodef_add_admin_container(
			array(
		...
		$blog_single_author_info_container = kloe_qodef_add_admin_container(
			array(
		...
		kloe_qodef_add_admin_field(
			array(
				'type' => 'yesno',
				'name' => 'blog_single_show_featured_image',
				'default_value' => 'no',
				'label' => 'Show Featured Image',
				'parent' => $panel_blog_single,
				'description' => 'Enabling this option will display featured image on Blog Single pages.'
			)
		);

	}

	add_action( 'kloe_qodef_options_map', 'kloe_qodef_blog_options_map', 11);
