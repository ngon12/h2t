<div class="qodef-blog-holder qodef-blog-type-standard-whole-post <?php echo esc_attr($blog_classes)?>"   data-blog-type="<?php echo esc_attr($blog_type)?>" <?php echo esc_attr(kloe_qodef_set_blog_holder_data_params()); ?> >
	<?php
	...
	if(kloe_qodef_options()->getOptionValue('pagination') == 'yes') {
		if (kloe_qodef_options()->getOptionValue('pagination_type') == 'navigation') {
			?>
