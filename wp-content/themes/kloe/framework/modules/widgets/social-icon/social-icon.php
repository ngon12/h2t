 ...
 */
class KloeQodefSocialIconWidget extends KloeQodefWidget {
    /**
    ...
    protected function setParams() {
        $this->params = array_merge(
            kloe_qodef_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'title' => 'Link',
    ...
    public function widget($args, $instance) {
        ...
        <a class="qodef-social-icon-widget-holder" <?php echo kloe_qodef_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php kloe_qodef_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
