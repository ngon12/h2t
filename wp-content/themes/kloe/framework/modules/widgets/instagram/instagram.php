...
class KloeQodefInstagramWidget extends KloeQodefWidget {
    protected $params;
    public function __construct() {
        parent::__construct(
            'qodef_instagram_widget',
            'Select Instagram Widget',
            array( 'description' => esc_html__( 'Display instagram images', 'kloe' ) )
        );
            ...
            foreach ($images_array as $image) { ?>
                <li>
                    <a href="<?php echo esc_url($instagram_api->getHelper()->getImageLink($image)); ?>" target="_blank">
                        <?php echo kloe_qodef_kses_img($instagram_api->getHelper()->getImageHTML($image, $image_size)); ?>
                    </a>
                </li>
            <?php } ?>
            </ul>
