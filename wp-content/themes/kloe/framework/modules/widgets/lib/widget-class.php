 ...
 *
 * Class KloeQodefWidget
 */
abstract class KloeQodefWidget extends WP_Widget {
    /**
    ...
    public function form($instance) {
        if(is_array($this->params) && count($this->params)) {
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'kloe'); ?></p>
        <?php }
    }
...
$kloe_qodef_Framework = KloeQodefFramework::get_instance();
$qodeSkinManager = new KloeQodefSkinManager();
$kloe_qodef_Framework->setSkin($qodeSkinManager->getSkin());
