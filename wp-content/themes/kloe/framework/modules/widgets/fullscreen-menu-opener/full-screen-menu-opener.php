...
class KloeQodefFullScreenMenuOpener extends KloeQodefWidget {
    ...
    public function widget($args, $instance) {
		...
		$icon_size = '';
		if ( isset($kloe_qodef_options['qodef_fullscreen_menu_icon_size']) && $kloe_qodef_options['qodef_fullscreen_menu_icon_size'] !== '' ) {
			$icon_size = $kloe_qodef_options['qodef_fullscreen_menu_icon_size'];
		}
		?>
...
<!--            <span class="popup_menu_inner">-->
            <span class="qodef-fullscreen-menu-opener-inner">
                <i class="qodef-line" <?php kloe_qodef_inline_style($fullscreen_icon_styles); ?>>&nbsp;</i>
            </span>
        </a>
    <?php }
