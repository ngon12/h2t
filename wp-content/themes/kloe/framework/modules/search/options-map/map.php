...
if ( ! function_exists('kloe_qodef_search_options_map') ) {

	function kloe_qodef_search_options_map() {
		...
		$search_panel = kloe_qodef_add_admin_panel(
			array(
				'title' => 'Search',
				'name' => 'search',
				'page' => '_search_page'
		...
		kloe_qodef_add_admin_field(
			array(
				...
				'options'		=> kloe_qodef_icon_collections()->getIconCollectionsExclude(array('linea_icons', 'simple_line_icons', 'dripicons'))
			)
		);

		$search_height_container = kloe_qodef_add_admin_container(
			array(
				'parent'			=> $search_panel,
		...
		$search_animation_container = kloe_qodef_add_admin_container(
			array(
				'parent'			=> $search_panel,
		...
		$search_icon_color_group = kloe_qodef_add_admin_group(
			array(
				'parent'	=> $search_panel,
				'title'		=> 'Icon Colors',
		...
		$search_icon_color_row = kloe_qodef_add_admin_row(
			array(
		...
		$search_icon_color_row2 = kloe_qodef_add_admin_row(
			array(
				'parent'	=> $search_icon_color_group,
		...
		$search_icon_background_group = kloe_qodef_add_admin_group(
			array(
				'parent'	=> $search_panel,
		...
		$search_icon_background_row = kloe_qodef_add_admin_row(
			array(
		...
		$enable_search_icon_text_container = kloe_qodef_add_admin_container(
			array(
				'parent'			=> $search_panel,
		...
		$enable_search_icon_text_group = kloe_qodef_add_admin_group(
			array(
		...
		$enable_search_icon_text_row = kloe_qodef_add_admin_row(
			array(
		...
		$enable_search_icon_text_row2 = kloe_qodef_add_admin_row(
			array(
				'parent'	=> $enable_search_icon_text_group,
		...
		$enable_search_icon_text_row3 = kloe_qodef_add_admin_row(
			array(
				'parent'	=> $enable_search_icon_text_group,
		...
		$search_icon_spacing_group = kloe_qodef_add_admin_group(
			array(
				'parent'	=> $search_panel,
				'title'		=> 'Icon Spacing',
		...
		$search_icon_spacing_row = kloe_qodef_add_admin_row(
			array(
		...
		$search_input_text_group = kloe_qodef_add_admin_group(
			array(
				'parent'	=> $search_panel,
		...
		$search_input_text_row = kloe_qodef_add_admin_row(
			array(
		...
		$search_input_text_row2 = kloe_qodef_add_admin_row(
			array(
				'parent'	=> $search_input_text_group,
		...
		$search_label_text_group = kloe_qodef_add_admin_group(
			array(
				'parent'	=> $search_panel,
		...
		$search_label_text_row = kloe_qodef_add_admin_row(
			array(
		...
		$search_label_text_row2 = kloe_qodef_add_admin_row(
			array(
				'parent'	=> $search_label_text_group,
		...
		$search_icon_group = kloe_qodef_add_admin_group(
			array(
				'parent'	=> $search_panel,
				'title'		=> 'Search Icon',
		...
		$search_icon_row = kloe_qodef_add_admin_row(
			array(
		...
		$search_close_icon_group = kloe_qodef_add_admin_group(
			array(
				'parent'	=> $search_panel,
				'title'		=> 'Search Close',
		...
		$search_close_icon_row = kloe_qodef_add_admin_row(
			array(
		...
		$search_bottom_border_group = kloe_qodef_add_admin_group(
			array(
				'parent'	=> $search_panel,
		...
		$search_bottom_border_row = kloe_qodef_add_admin_row(
			array(
	...
	add_action('kloe_qodef_options_map', 'kloe_qodef_search_options_map', 13);
