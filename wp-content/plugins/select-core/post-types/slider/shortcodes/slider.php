...
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
            ...
            if($kloe_qodef_options['smooth_page_transitions'] == "yes" && $kloe_qodef_options['smooth_pt_spinner_type'] != "") {
                $ajax_loader = '<div class="qodef-st-loader"><div class="qodef-st-loader1">' . kloe_qodef_loading_spinners(true) . '</div></div>';
            }else{
                $ajax_loader = '<div class="qodef-st-loader"><div class="qodef-st-loader1">'. kloe_qodef_loading_spinner_pulse() .'</div></div>';
            }

            /* set slider preloader - end */

            /* set padding for slider arrows - start */
            $slider_arrows_padding = "padding-top: " . esc_attr($this->kloe_qodef_get_slider_navigation_padding()) . "px;";
            /* set padding for slider arrows - end */

            $html .= '<div id="qodef-' . esc_attr($slider) . '" ' . $slider_anchor . ' ' . $responsiveness_data . ' ' . $responsive_coefficients_graphic_data . ' ' . $responsive_coefficients_title_data . ' ' . $responsive_coefficients_subtitle_data . ' ' . $responsive_coefficients_text_data . ' ' . $responsive_coefficients_button_data . ' class="carousel slide ' . esc_attr($animation_type_class . ' ' . $full_screen_class . ' ' . $responsive_height_class . ' ' . $height_class . ' ' . $auto_start_class . ' ' . $header_effect_class . ' ' . $slider_numbers_class .  ' ' . $slider_thumbs_class) . ' " ' . $slide_animation_timeout . ' ' . $data_height . ' ' . $data_parallax_effect . ' '.kloe_qodef_get_inline_style($slide_holder_height).'><div class="qodef-slider-preloader">'.$ajax_loader.'</div>';
            $html .= '<div class="carousel-inner ' . esc_attr($slider_css_position_class) . '" '.kloe_qodef_get_inline_style($carouselinner_height).' '.$data_parallax_transform.'>';
            ...
            if (have_posts()) : $postCount = 0;
                while (have_posts()) : the_post();
                    ...
                    $thumbnail_attributes = kloe_qodef_get_attachment_meta_from_url($thumbnail, array('width','height'));
                    ...
                    $thumbnail_link = "";
                    if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_thumbnail_link", true)) != "") {
                    ...
                    $slide_content_style = "";
                    if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_text_content_top_margin", true)) != "") {
                        $slide_content_style .= "margin-top: " . esc_attr($meta_temp) . "px;";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_text_content_bottom_margin", true)) != "") {
					...
					$slide_graphic_style = "";
					if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_graphic_top_padding", true)) != "") {
                        $slide_graphic_style .= "padding-top: " . esc_attr($meta_temp) . "px;";
                    }
					if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_graphic_bottom_padding", true)) != "") {
                    ...
                    if (get_post_meta(get_the_ID(), "qodef_slide_content_vertical_middle_type", true) == 'window_top') {
                        ...
                        $slide_item_padding_value = $this->kloe_qodef_get_slider_item_padding();
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qodef_slide_content_vertical_middle", true) == "yes") {
						...
						if(($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_vertical_content_width", true)) != ""){
							$vertical_content_width = "width:" . esc_attr($meta_temp) . "%; position:relative; ";
						}
						if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_vertical_content_left", true)) != "") {
                            $vertical_content_xaxis = "left:" . esc_attr($meta_temp) . "%;";
                        }else if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_vertical_content_right", true)) != "") {
                                $vertical_content_xaxis = "right:" . esc_attr($meta_temp) . "%;";
                        }
                    } else {

                        if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_content_width", true)) != "") {
                            $content_width = "width:" . esc_attr($meta_temp) . "%;";
                        } else {
                            $content_width = "width:80%;";
                        }

                        if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_content_left", true)) != "") {
                            $content_xaxis = "left:" . esc_attr($meta_temp) . "%;";
                        } else {
                            if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_content_right", true)) != "") {
                                $content_xaxis = "right:" . esc_attr($meta_temp) . "%;";
                            } else {
                                $content_xaxis = "left: 10%;";
                            }
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_content_top", true)) != "") {
                            $content_yaxis_start = "top:" . esc_attr($meta_temp) . "%;";
                            $content_yaxis_end = "top:" . (esc_attr($meta_temp) - 10) . "%;";
                        } else {
                            if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_content_bottom", true)) != "") {
                        ...
                        if ($separate_text_graphic == 'yes' && ($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_text_width", true)) != "") {
                            $content_width = "width:" . esc_attr($meta_temp) . "%;";
                        }

                        if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_graphic_width", true)) != "") {
                            $graphic_width = "width:" . esc_attr($meta_temp) . "%;";
                        } else {
                            $graphic_width = "width:50%;";
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_graphic_left", true)) != "") {
                            $graphic_xaxis = "left:" . esc_attr($meta_temp) . "%;";
                        } else {
                            if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_graphic_right", true)) != "") {
                                $graphic_xaxis = "right:" . esc_attr($meta_temp) . "%;";
                            } else {
                                $graphic_xaxis = "left: 25%;";
                            }
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_graphic_top", true)) != "") {
                            $graphic_yaxis_start = "top:" . esc_attr($meta_temp) . "%;";
                            $graphic_yaxis_end = "top:" . (esc_attr($meta_temp) - 10) . "%;";
                        } else {
                            if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_graphic_bottom", true)) != "") {
                    ...
                    if ($slide_type == 'video') {
                        ...
                        $html .= '<div class="qodef-video"><div class="qodef-mobile-video-image" '.kloe_qodef_get_inline_style('background-image: url(' . esc_url($video_image) . ')').'></div><div class="qodef-video-overlay';
                        ...
                        $html .= '<div class="qodef-image" '.kloe_qodef_get_inline_style('background-image:url(' . esc_url($image) . ')').'>';
                        if ($slider_thumbs == 'no') {
                            $html .= '<img src="' . esc_url($image) . '" alt="' . esc_attr($title) . '">';
                        }

                        if ($image_overlay_pattern !== "") {
                            $html .= '<div class="qodef-image-pattern" '.kloe_qodef_get_inline_style('background: url(' . esc_url($image_overlay_pattern) . ') repeat 0 0').'></div>';
                        }
                        $html .= '</div>';
                    }
                    ...
                    if (($meta_temp_subtitle = get_post_meta(get_the_ID(), "qodef_slide_subtitle", true)) != "") {
                        ...
                        if (($meta_temp_hide_shadow = get_post_meta(get_the_ID(), 'qodef_slide_hide_shadow', true)) == 'yes') {
                        ...
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_subtitle_background_color', true)) !== '') {
                            ...
                            $slide_subtitle_span_style_array[] = 'background-color: ' . esc_attr(kloe_qodef_rgba_color($slide_subtitle_bg_color, $slide_subtitle_bg_transparency)) . '';
                        }
                        ...
                        //$html_text .= '<h3 class="qodef-slide-subtitle" style="'.$slide_subtitle_style.'"><span style="'.$slide_subtitle_span_style.'">' . wp_kses_post(get_post_meta(get_the_ID(), 'qodef_slide_subtitle', true)) . '</span></h3>';
                        //kloe_qodef_inline_style($slide_subtitle_style_array); var_dump($slide_subtitle_style_array); die();
                        $html_text .= '<h3 class="qodef-slide-subtitle" '.kloe_qodef_get_inline_style($slide_subtitle_style_array).'><span '.kloe_qodef_get_inline_style($slide_subtitle_span_style_array).'>' . wp_kses_post($meta_temp_subtitle) . '</span></h3>';
                        $html_text .= '</div>';
                    }
                    ...
                    if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_title_background_color', true)) !== '') {
                        ...
                        $slide_title_span_style_array[] = 'background-color: ' . esc_attr(kloe_qodef_rgba_color($slide_title_bg_color, $slide_title_bg_transparency)) . '';
                    }
                    ...
                    if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_title_border', true)) != '' && $meta_temp == 'yes') {

                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_title_border_thickness', true)) != '') {
                            $border_style_array[] = 'border-width: ' . esc_attr($meta_temp) . 'px';
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_title_border_style', true)) != '') {
                            $border_style_array[] = 'border-style: ' . esc_attr($meta_temp) . '';
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slider_title_border_color', true)) != '') {
                    ...
                    if (get_post_meta(get_the_ID(), "qodef_slide_hide_title", true) == 'no') {
                        $html_text .= '<div class="qodef-el">';
                        $html_text .= '<h2 class="qodef-slide-title" '.kloe_qodef_get_inline_style($slide_title_style_array).'>';

                        if(($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_title_link", true)) != '') {
                            $html_text .= '<a href="'.esc_url($meta_temp).'" target="'.esc_attr(get_post_meta(get_the_ID(), "qodef_slide_title_target", true)).'">';
                        }
                        $html_text .= '<span '.kloe_qodef_get_inline_style($slide_title_span_style_array).'>'.wp_kses_post($title).'</span>';
                        if($meta_temp != '') {
                            $html_text .= '</a>';
                        }
                    ...
                    if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_text_color", true)) != "") {
                        $slide_text_style_array[] = "color: " . esc_attr($meta_temp) . "";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_text_font_size", true)) != "") {
                        $slide_text_style_array[] = "font-size: " . esc_attr($meta_temp) . "px";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_text_line_height", true)) != "") {
                    ...
                    if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_text_font_style", true)) != "") {
                        $slide_text_style_array[] = "font-style: " . esc_attr($meta_temp) . "";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_text_font_weight", true)) != "") {
                        $slide_text_style_array[] = "font-weight: " . esc_attr($meta_temp) . "";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_text_letter_spacing', true) )!== '') {
                        $slide_text_style_array[] = 'letter-spacing: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_text_text_transform', true) )!== '') {
                        $slide_text_style_array[] = 'text-transform: ' . esc_attr($meta_temp) . '';
                    }
                    if ($meta_temp_hide_shadow == 'yes') {
                        $slide_text_style_array[] = 'text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.4)';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_text_background_color', true) )!== '') {
                        $slide_text_bg_color = esc_attr($meta_temp);
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_text_bg_color_transparency', true)) != '') {
                            $slide_text_bg_transparency = esc_attr($meta_temp);
                        } else {
                            $slide_text_bg_transparency = 1;
                        }
                        $slide_text_span_style_array[] = 'background-color: ' . esc_attr(kloe_qodef_rgba_color($slide_text_bg_color, $slide_text_bg_transparency)) . '';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_text_padding_top', true)) != '') {
                        $slide_text_span_style_array[] = 'padding-top: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_text_padding_right', true)) != '') {
                        $slide_text_span_style_array[] = 'padding-right: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_text_padding_bottom', true)) != '') {
                        $slide_text_span_style_array[] = 'padding-bottom: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_text_padding_left', true)) != '') {
                    ...
                    if (get_post_meta(get_the_ID(), "qodef_slide_text", true) != "") {
                        ...
                        if ($slide_text_separator_var == 'yes') {
                            ...
                            $html_text .= '<h3 class="qodef-slide-text" '.qodef_burst_get_inline_style($slide_text_style).'><span '.qodef_burst_get_inline_style($slide_text_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), "qodef_slide-text", true)) . '</span></h3>';
                        }
                        $html_text .= '</div>';
                    }*/
                    if (($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_text", true)) != "") {
                        $html_text .= '<div class="qodef-el">';
                        $html_text .= '<h3 class="qodef-slide-text" '.kloe_qodef_get_inline_style($slide_text_style_array).'><span '.kloe_qodef_get_inline_style($slide_text_span_style_array).'>'.wp_kses_post($meta_temp).'</span></h3>';
                        $html_text .= '</div>';
                    }
                    ...
                    $meta_temp_b1_label = get_post_meta(get_the_ID(), "qodef_slide_button_label", true);
                    $meta_temp_b1_icon_pack = get_post_meta(get_the_ID(), "qodef_button1_icon_pack", true);
                    $meta_temp_b1_link = get_post_meta(get_the_ID(), "qodef_slide_button_link", true);
                    ...
                    $meta_temp_b2_label = get_post_meta(get_the_ID(), "qodef_slide_button_label2", true);
                    $meta_temp_b2_icon_pack = get_post_meta(get_the_ID(), "qodef_button2_icon_pack", true);
                    $meta_temp_b2_link = get_post_meta(get_the_ID(), "qodef_slide_button_link2", true);
                    ...
                    if ($is_first_button_shown) {
                        ...
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_size', true)) != '') {
                            $button1_params['size'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_type', true)) != '') {
                        ...
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_target', true)) != '') {
                            $button1_params['target'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_text_color', true)) != '') {
                            $button1_params['color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_text_hover_color', true)) != '') {
                            $button1_params['hover_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_background_color', true)) != '') {
                            $button1_params['background_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_background_hover_color', true)) != '') {
                            $button1_params['hover_background_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_border_color', true)) != '') {
                            $button1_params['border_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_border_hover_color', true)) != '') {
                            $button1_params['hover_border_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_font_size', true)) != '') {
                            $button1_params['font_size'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_font_weight', true)) != '') {
                            $button1_params['font_weight'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_margin1', true)) != '') {
                            $button1_params['margin'] = $meta_temp;
                        }

                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_line_height', true)) != '') {
                            $button1_params['line_height'] = $meta_temp;
                        }

                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_letter_spacing', true)) != '') {
                            $button1_params['letter_spacing'] = $meta_temp;
                        }

                        if ($meta_temp_b1_icon_pack != '') {
                            $button1_params['icon_pack'] = $meta_temp_b1_icon_pack;
                            $iconPackName = kloe_qodef_icon_collections()->getIconCollectionParamNameByKey($button1_params['icon_pack']);
                            if (($meta_temp = get_post_meta(get_the_ID(), 'button1_icon_'.$iconPackName, true)) != '') {
                                $button1_params[$iconPackName] = $meta_temp;
                            }
                        }
                        $html_text .= kloe_qodef_get_button_html($button1_params);
                    }

                    if ($is_second_button_shown) {
                        $button2_params = array();
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_size2', true)) != '') {
                            $button2_params['size'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_type2', true)) != '') {
                        ...
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_target2', true)) != '') {
                            $button2_params['target'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_text_color2', true)) != '') {
                            $button2_params['color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_text_hover_color2', true)) != '') {
                            $button2_params['hover_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_background_color2', true)) != '') {
                            $button2_params['background_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_background_hover_color2', true)) != '') {
                            $button2_params['hover_background_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_border_color2', true)) != '') {
                            $button2_params['border_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_border_hover_color2', true)) != '') {
                            $button2_params['hover_border_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_font_size2', true)) != '') {
                            $button2_params['font_size'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_font_weight2', true)) != '') {
                            $button2_params['font_weight'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_margin2', true)) != '') {
                            $button2_params['margin'] = $meta_temp;
                        }

                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_line_height2', true)) != '') {
                            $button1_params['line_height'] = $meta_temp;
                        }

                        if (($meta_temp = get_post_meta(get_the_ID(), 'qodef_slide_button_letter_spacing2', true)) != '') {
                            $button1_params['letter_spacing'] = $meta_temp;
                        }

                        if ($meta_temp_b2_icon_pack != '') {
                            $button2_params['icon_pack'] = $meta_temp_b2_icon_pack;
                            $iconPackName = kloe_qodef_icon_collections()->getIconCollectionParamNameByKey($button2_params['icon_pack']);
                            if (($meta_temp = get_post_meta(get_the_ID(), 'button2_icon_'.$iconPackName, true)) != '') {
                                $button2_params[$iconPackName] = $meta_temp;
                            }
                        }
                        $html_text .= kloe_qodef_get_button_html($button2_params);
                    }
                    ...
                    $html_slider_anchor = '';
                    if (($meta_temp_anchor = get_post_meta(get_the_ID(), "qodef_slide_scroll_to_section", true)) !== '') {
                        ...
                        if(($meta_temp_anchor_position = get_post_meta(get_the_ID(), "qodef_slide_scroll_to_section_position", true)) == 'in_content' || $meta_temp_anchor_position == ''){
                            $slide_anchor_classes .= 'qodef-el qodef-slider-anchor-in-content';
                        }
                        elseif($meta_temp_anchor_position == 'bottom_of_slider'){
                            $slide_anchor_classes .= 'qodef-slider-anchor-on-bottom-of-the-slider';
                        }

                        $html_slider_anchor = '<div class="qodef-slide-anchor-holder '.esc_attr($slide_anchor_classes).'"><a ' . $slide_anchor_style . ' class="qodef-slide-anchor-button qodef-anchor" href="' . esc_url($meta_temp_anchor) . '"><i class="icon-mouse"></i><span class="scroll-text">Scroll Down</span></a></div>';
                    }

                    if($html_slider_anchor != '' && (($meta_temp_anchor_position = get_post_meta(get_the_ID(), "qodef_slide_scroll_to_section_position", true)) == 'in_content' || $meta_temp_anchor_position == '')){
                    ...
                    if ($separate_text_graphic != 'yes') {
                        $html .= '<div class="qodef-slider-content ' . esc_attr($content_alignment) .'" '.kloe_qodef_get_inline_style($content_width . $content_xaxis . $content_yaxis_start).' '.$slide_data_start.' '.$slide_data_end.'>';
							if(($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_content_vertical_middle", true)) == "yes"){
								$html .= '<div class="qodef-slider-content-inner ' . esc_attr($content_animation . ' ' . $content_animation_direction) .'" '.kloe_qodef_get_inline_style($vertical_content_width . $vertical_content_xaxis).'>';
							}
							$html .= $html_thumb;
							$html .= $html_text;
							if($meta_temp == "yes"){
                        ...
                        $html .= '<div class="qodef-slider-content qodef-graphic-content ' . esc_attr($graphic_alignment) . '" '.kloe_qodef_get_inline_style($graphic_width . $graphic_xaxis . $graphic_yaxis_start).' '. $graphic_data_start .' '.$graphic_data_end.'>';
							if(($meta_temp = get_post_meta(get_the_ID(), "qodef_slide_content_vertical_middle", true)) == "yes"){
								$html .= '<div class="qodef-slider-content-inner" '.kloe_qodef_get_inline_style($vertical_content_width . $vertical_content_xaxis).'>';
							}
							$html .= $html_thumb;
							if($meta_temp == "yes"){
								$html .= '</div>';
     ...
     **/
    function kloe_qodef_get_slider_item_padding() {
        return apply_filters('kloe_qodef_slider_item_padding', 0);
    }

    /**
     * Function that returns slider navigation pading
     **/
    function kloe_qodef_get_slider_navigation_padding() {
        return apply_filters('kloe_qodef_slider_navigation_padding', 0);
    }
}