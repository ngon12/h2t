...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $kloe_qodef_Framework, $kloe_qodef_options;
        ...
        if(qode_core_theme_installed()) {
            $menuPosition = $kloe_qodef_Framework->getSkin()->getMenuItemPosition('portfolio');
            $menuIcon = $kloe_qodef_Framework->getSkin()->getMenuIcon('portfolio');

            if(isset($kloe_qodef_options['portfolio_single_slug'])) {
                if($kloe_qodef_options['portfolio_single_slug'] != ""){
                    $slug = $kloe_qodef_options['portfolio_single_slug'];
                }
            }
        }
